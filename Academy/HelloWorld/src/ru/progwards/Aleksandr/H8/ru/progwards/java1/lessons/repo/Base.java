package ru.progwards.Aleksandr.H8.ru.progwards.java1.lessons.repo;
...
public class Base {
    ...
    public static int subtraction(int x, int y) {
        System.out.println("Вызвана функция subtraction() с параметрами " +
                X_EQUALS + x + ", " + Y_EQUALS + y);
        return x - y;
    }
    public static int addition(int x, int y) {
        System.out.println("Вызвана функция addition() с параметрами " +
                X_EQUALS + x + ", " + Y_EQUALS + y);
        return x + y;
    }
    public static int multiplication(int x, int y) {
        System.out.println("Вызвана функция multiplication() с параметрами " +
                X_EQUALS + x + ", " + Y_EQUALS + y);
        return x*y;
    }
    ...
    public static void calculation(int a, int b, int c) {
        ...
        System.out.println("a^3 = " + multiplication(multiplication(a, b), c));
